...
CREATE TABLE REF_QUESTION_ATTRIBUTE (
    REF_QUESTION_ATTRIBUTE_UK NUMBER,
    REF_ASS_VERSION_CODE VARCHAR2(100),
    VERSION_NUMBER VARCHAR2(100),
    REF_SECTION_CODE VARCHAR2(100),
    REF_QUESTION_CODE VARCHAR2(100),
    UI_ATTRIBUTE_ELM VARCHAR2(50),
    UI_ATTRIBUTE_CAT VARCHAR2(50),
    ATTRIBUTE_VALUE VARCHAR2(256),
    CHECKSUM VARCHAR2(4000),
    CREATE_DATE DATE,
    CREATE_USER VARCHAR2(100),
    LASTUPD_DATE DATE,
    LASTUPD_USER VARCHAR2(100),
    CONSTRAINT REF_QUESTION_ATTRIBUTE_PK PRIMARY KEY (REF_ASS_VERSION_CODE,VERSION_NUMBER,REF_SECTION_CODE,REF_QUESTION_CODE,UI_ATTRIBUTE_CAT,UI_ATTRIBUTE_ELM)
);

CREATE TABLE REF_ADD_TEXT (
    REF_ADD_TEXT_PK NUMBER,
    TEXT_POSITION_ELM VARCHAR2(50),
    TEXT_POSITION_CAT VARCHAR2(50),
    ...
    LASTUPD_DATE DATE,
    LASTUPD_USER VARCHAR2(100),
    CONSTRAINT REF_ADD_TEXT_PK PRIMARY KEY (REF_ADD_TEXT_PK)
);