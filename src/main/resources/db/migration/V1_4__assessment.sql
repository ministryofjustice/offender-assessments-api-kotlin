...
(
    ...
    OSP_I_RISK_RECON_ELM VARCHAR2(2),
    OSP_I_RISK_RECON_CAT VARCHAR2(50),
    OSP_I_PERCENTAGE_SCORE NUMBER(8,4),
    OSP_C_RISK_RECON_ELM VARCHAR2(2),
    OSP_C_RISK_RECON_CAT VARCHAR2(50),
    OSP_C_PERCENTAGE_SCORE NUMBER(8,4),
    RSR_RISK_RECON_ELM VARCHAR2(2),
    RSR_RISK_RECON_CAT VARCHAR2(50),
    RSR_PERCENTAGE_SCORE NUMBER(8,4),
    RSR_STATIC_OR_DYNAMIC VARCHAR2(50),
    RSR_ALGORITHM_VERSION NUMBER,
    CREATED_EXTERNALLY_IND VARCHAR2(1) DEFAULT 'N',
	constraint ELM_FK60
