...
DELETE FROM BASIC_SENTENCE_PLAN_OBJ where OASYS_SET_PK in (100, 200, 300, 400, 600);
DELETE FROM SSP_OBJECTIVES_IN_SET where OASYS_SET_PK in (100, 200, 300, 400, 600);
DELETE FROM SSP_OBJECTIVES_IN_SET where OASYS_SET_PK in (100, 200, 300, 400, 600);
...
DELETE FROM OASYS_SECTION where OASYS_SET_PK in (100, 200, 300, 400, 600);

DELETE FROM OASYS_SET where OASYS_SET_PK in (100, 200, 300, 400, 600);

DELETE FROM OASYS_ASSESSMENT_GROUP where OASYS_ASSESSMENT_GROUP_PK = 100;
DELETE FROM OASYS_ASSESSMENT_GROUP where OASYS_ASSESSMENT_GROUP_PK = 200;